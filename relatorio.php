...
<body>
    <div class="container">
        ...
        <?php
        // Exibe mensagens de sucesso ou erro (bloco original no topo)
        ...
        if (isset($_GET['message']) && (!isset($_GET['display_in_footer']) || $_GET['display_in_footer'] != 'true')) {
            ...
            $type = isset($_GET['type_message']) ? htmlspecialchars($_GET['type_message']) : 'success'; // Usamos 'type_message' para não conflitar com 'report_type'
                        ...
                        <div class="flex flex-wrap -mx-2 mb-4">
                            <div class="w-full md:w-1/2 px-2 mb-4 md:mb-0">
                                ...
                                <select id="month" name="month" class="form-control" onchange="this.form.submit()">
                                    <?php
                                    // Mapeamento de meses (já definido no topo do script)
                                    // $months = [...];
    ...
    <footer class="app-footer">
        ...
        <?php
        // Bloco PHP para exibir mensagens no rodapé
        ...
        // Se você remover o bloco PHP de mensagem do topo, a mensagem só aparecerá aqui.
        if (isset($_GET['message'])) {
            $message = htmlspecialchars($_GET['message']);
            $type = isset($_GET['type_message']) ? htmlspecialchars($_GET['type_message']) : 'success'; // Usa 'type_message' se existir, senão 'success'
            echo "<div class='message-box message-$type'>$message</div>";
        }
        ?>
    </footer>
