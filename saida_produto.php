...
<body>
    <div class="container">
        ...
        <?php
        // Exibe mensagens de sucesso ou erro (original, no topo)
        // Você pode remover este bloco se quiser que as mensagens apareçam APENAS no rodapé.
        // Se ambos estiverem presentes, a mensagem pode aparecer duas vezes.
    ...
    <footer class="app-footer">
        ...
        // Se você quiser que a mensagem APENAS apareça no rodapé,
        // remova o primeiro bloco PHP de mensagem (após a tag <h1>) desta página.
        if (isset($_GET['message'])) {
            $message = htmlspecialchars($_GET['message']);
            $type = isset($_GET['type_message']) ? htmlspecialchars($_GET['type_message']) : 'success'; // Usa 'type_message' do processa_saida.php
            echo "<div class='message-box message-$type'>$message</div>";
        }
        ?>
    </footer>
